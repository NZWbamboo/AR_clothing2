...
/// <summary>
/// 这个界面需要由Kinect手势管理器实现，比如KinectGestures-class本身
...
public interface GestureManagerInterface
{
    ...
    /// 获取手势关节索引的列表。
    /// </summary>
    /// <returns>所需的联合指数。</returns>
    /// <param name="manager">KinectManager实例</param>
    ...
    /// </summary>
    /// <param name="userId">人物ID</param>
    /// <param name="gestureData">Gesture-data structure手势数据结构</param>
    /// <param name="timestamp">Current time当前时间</param>
    /// <param name="jointsPos">Joints-position array关节位置数组</param>
    /// <param name="jointsTracked">Joints-tracked array关节跟踪阵列</param>
...
/// <summary>
/// KinectGestures是处理程序化Kinect手势的实用程序类
...
public class KinectGestures : MonoBehaviour, GestureManagerInterface
{
    ...
    public interface GestureListenerInterface
	{
        ...
        /// </summary>
        /// <returns><c>true</c>, if the gesture detection must be restarted,如果必须重新启动手势检测， <c>false</c> otherwise.</returns>
        /// <param name="userId">User ID</param>
        /// <param name="userIndex">User index</param>
        /// <param name="gesture">Gesture type</param>
        /// <param name="joint">Joint type</param>
        ...
        /// </summary>
        /// <returns><c>true</c>, if the gesture detection must be retarted,如果手势检测必须延迟， <c>false</c> otherwise.</returns>
        /// <param name="userId">User ID</param>
        /// <param name="userIndex">User index</param>
        /// <param name="gesture">Gesture type</param>
        /// <param name="joint">Joint type</param>
